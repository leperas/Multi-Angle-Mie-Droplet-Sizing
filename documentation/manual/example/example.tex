...
\input{./example/make_database/make_database.tex}

\section{Make an Image Data Set}

\input{./example/make_images/make_images.tex}

\section{Image Processing the Data Set}

%\input{./example/do_processing/do_processing.tex}

\section{Size Processing the Data Set}

%\input{./example/do_sizing/do_sizing.tex}
